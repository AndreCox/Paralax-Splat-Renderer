...
var AbortablePromise = class _AbortablePromise {
  static idGen = 0;
...
var UncompressedSplatArray = class _UncompressedSplatArray {
  static OFFSET = {
    X: 0,
    Y: 1,
    Z: 2,
...
var SplatBuffer = class _SplatBuffer {
...
var PlayCanvasCompressedPlyParser = class _PlayCanvasCompressedPlyParser {
...
var PlyParserUtils = class _PlyParserUtils {
...
var INRIAV1PlyParser = class _INRIAV1PlyParser {
  constructor() {
...
var INRIAV2PlyParser = class _INRIAV2PlyParser {
  constructor() {
    this.plyParserutils = new PlyParserUtils();
  }
...
var SplatParser = class _SplatParser {
...
var KSplatLoader = class _KSplatLoader {
  ...
  static downloadFile = /* @__PURE__ */ (function() {
    let downLoadLink;
...
var SplatTreeNode = class _SplatTreeNode {
  static idGen = 0;
...
var SplatMesh = class _SplatMesh extends Mesh {
  ...
  setupDistancesComputationTransformFeedback = /* @__PURE__ */ (function() {
   ...
   */
  fillTransformsArray = /* @__PURE__ */ (function() {
    const tempArray = [];
   ...
   */
  getSplatCenter = /* @__PURE__ */ (function() {
    const paramsObj = {};
   ...
   */
  getSplatColor = /* @__PURE__ */ (function() {
    const paramsObj = {};
...
var Viewer = class _Viewer {
   ...
   */
  addSplatBuffers = /* @__PURE__ */ (function() {
   ...
   * @return {object} Object containing info about the splats that are updated
   */
  addSplatBuffersToMesh = /* @__PURE__ */ (function() {
  ...
  timingSensitiveUpdates = /* @__PURE__ */ (function() {
    let lastUpdateTime;
    return function() {
      const currentTime = getCurrentTime();
